...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const tags = yield (0, github_1.listTags)(/true/i.test(shouldFetchAllTags));
        const validTags = yield (0, utils_1.getValidTags)(tags, prefixRegex);
        ...
        yield (0, github_1.createTag)(newTag, createAnnotatedTag, tagExists, commitRef);
    });
}
