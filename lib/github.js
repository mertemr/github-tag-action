...
function createTag(newTag, createAnnotatedTag, update, GITHUB_SHA) {
    return __awaiter(this, void 0, void 0, function* () {
        const octokit = getOctokitSingleton();
        ...
        if (update) {
            ...
            yield octokit.git.updateRef(Object.assign(Object.assign({}, github_1.context.repo), { ref: `tags/${newTag}`, sha: annotatedTag ? annotatedTag.data.sha : GITHUB_SHA, force: true }));
        }
        else {
